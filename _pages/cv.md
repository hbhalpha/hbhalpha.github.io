...
**[R.1]** Ronghao Dang*, Jiayan Guo*, **Bohan Hou*** (Core and Equal Contribution) , Sicong Leng* , et al . *RynnBrain: Open Embodied Foundation Models*  

**[R.2]** **Bohan Hou**, Haokun Wen, Haoqiang Lin, Xuemeng Song and Liqiang Nie (2025). *Visual Anchor Point for Multimodal Document Retrieval.* WWW ’25 Multimodal Document Retrieval Challenge (Oral). CCF-A Conference.
